      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-10 lg:py-20">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-3">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
              <p className="text-xs uppercase text-neutral-500">Cobertura</p>
              <p className="mt-2 text-sm font-semibold text-white">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          {canales.map((canal) => {
            ...
            return (
              <article
                key={canal.titulo}
                className="rounded-2xl border border-white/10 bg-white/[0.03] p-4 sm:p-5 transition hover:border-red-500/40 hover:bg-white/[0.05]"
              >
              ...
              >
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.02] px-4 py-2.5 text-sm font-medium text-white hover:border-red-500/40 hover:bg-white/[0.05]"
                  >
                    <Phone size={16} />
                    Llamar
                  </a>
                  ...
                  {persona.email && (
                    <a
                      ...
                      className="inline-flex min-w-0 items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.02] px-4 py-2.5 text-sm font-medium text-white hover:border-red-500/40 hover:bg-white/[0.05] sm:col-span-2"
                    >
