...
export const productos: Producto[] = [
  {
    ...
    marca: "brother",
    imagen: "/Productos/toner-brother-tn-1060(Original).webp",
    categoriaId: "toners",
  ...
  },
  {
    ...
    marca: "hp",
    imagen: "/Productos/toner-HP-30A(Original).webp",
    categoriaId: "toners",
    subcategoriaId: "originales",
  },
  {
    ...
    marca: "epson",
    imagen: "/Productos/toner-epson(Original).webp",
    categoriaId: "toners",
    subcategoriaId: "originales",
  },
  {
    ...
    descripcion: "Tóners originales diseñados para máxima eficiencia operativa.",
    marca: "ricoh",
    imagen: "/Productos/toner-Ricoh-P311(Original).webp",
    categoriaId: "toners",
    subcategoriaId: "originales",
  },
  {
    ...
    marca: "xerox",
    imagen: "/Productos/Toner-Xerox-phaser-3020-3025(Original).webp",
    categoriaId: "toners",
    subcategoriaId: "originales",
  },
  {
    ...
    marca: "kyocera",
    imagen: "/Productos/Toner-Kyocera-TK-172(Original).webp",
    categoriaId: "toners",
    subcategoriaId: "originales",
  },
  {
    ...
    marca: "lexmark",
    imagen: "/Productos/toner-Lexmark-51b4000(Original).webp",
    categoriaId: "toners",
    subcategoriaId: "originales",
  },
  {
    ...
    marca: "Alternativo",
    imagen: "/Productos/Toners-Alternativos.webp",
    categoriaId: "toners",
  ...
  },
  {
    ...
    marca: "impresion",
    imagen: "/Productos/Papeles-A4.webp",
    categoriaId: "papeles",
  ...
  
  {
    ...
    marca: "hardware",
    imagen: "/Productos/Hardware-Imagen.webp",
...

  {
    ...
    marca: "hardware",
    imagen: "/Productos/computadoras.webp",
    categoriaId: "tecnologia",
    subcategoriaId: "hardware",
...

  {
    ...
    marca: "hardware",
    imagen: "/Productos/Monitores.webp",
    categoriaId: "tecnologia",
    subcategoriaId: "Hardware",
    listaId:"monitores"
  },

  {
    ...
    marca: "",
    imagen: "/Productos/Teclados-Mouse.webp",
    categoriaId: "tecnologia",
...

  {
    ...
    marca: "",
    imagen: "/Productos/Parlantes.webp",
    categoriaId: "tecnologia",
  ...
  },
   {
    ...
    marca: "",
    imagen: "/Productos/Auriculares.webp",
    categoriaId: "tecnologia",
    subcategoriaId: "Audio",
    listaId:"auriculares"
  },
  ...
  
  {
    ...
    marca: "maped",
    imagen: "/Productos/Grapadoras.webp",
...

  {
    ...
    marca: "",
    imagen: "/Productos/Escritura.webp",
    categoriaId: "libreria",
